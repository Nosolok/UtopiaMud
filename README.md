...
### Особенности
* Все настройки игры, параметры, заклинания и предметы хранятся в удобных для редактирования текстовых файлах.
* Локации, зоны и комнаты хранятся в базе данных. Удобный внутриигровой редактор.
